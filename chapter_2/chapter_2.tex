...
\begin{document}
	...
	In conclusion, we have derived the matrix elements of a sum of one-electron operators using $\langle K | \mathscr{H} | L \rangle = (N!)^{1/2} \langle K^{\rm HP} | \mathscr{H} | L \rangle$.
